...
function new_game(canvas_width, canvas_height, canvas_as_screen_if_possible = false, canvas_color = &h00000000)
	...
	game.compositor.SetDrawTo(game.screen, canvas_color)
